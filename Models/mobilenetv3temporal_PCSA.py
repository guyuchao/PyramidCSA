...
class Fastnet(nn.Module):
    def __init__(self):
        ...
        self.temporal_high=T_Moduel(32)
    ...
    def freezen_feature_extractor(self,logger):
    ...
    def forward(self, x):
        if len(x.shape)==4:
            ...
            high_feature=self.temporal_high(high_feature)
            high_feature = high_feature.view(-1, *high_feature.shape[2:])
...
if __name__=="__main__":
    a=torch.zeros(1,5,3,224,336).cuda()
    mobile=Fastnet().cuda()
